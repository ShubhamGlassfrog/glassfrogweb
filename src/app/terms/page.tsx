        ...
        <div className="bg-white p-28 justify-center items-center w-full">
            ...
            <div>
                ...
                <ol className="list-none">
                    ...
                    <li className="worksans mb-4">
                        ...
                        <ul className="list-disc list-inside mt-2">
                            ...
                            <li className="worksans">
                                ...
                                <ul className="list-disc list-inside mt-2">
                                    <li className="worksans"><strong>i)</strong> Any person above 18 years of Age</li>
                                    <li className="worksans"><strong>ii)</strong> Any person competent to enter into a contract as per Indian Contract Act, 1872</li>
                                    <li className="worksans"><strong>iii)</strong> Not debarred under any law to do business</li>
                                </ul>
                            </li>
                            <li className="worksans">
                                <strong>f.</strong> <strong>BOTS:</strong> Automatic robotic programs used for installing the App in the mobile or Virtual phones system without manual interference.
                            </li>
                            <li className="worksans">
                                <strong>g.</strong> <strong>Virtual Phones:</strong> Any program installed through a virtual environment created on a computer system which may appear as if the app is installed on an actual smartphone.
                            </li>
                        </ul>
                    </li>
                    <li className="worksans mb-4">
                        ...
                        <ul className="list-disc list-inside mt-2">
                            <li className="worksans"><strong>a.</strong> The buddy program is a referral program.</li>
                    ...
                    <li className="worksans mb-4">
                        <img src="./4436481.png" className="inline-block mr-2 h-5" alt="icon" />
                        <strong>Referral Rewards and Payment Method</strong>
                        <ul className="list-disc list-inside mt-2">
