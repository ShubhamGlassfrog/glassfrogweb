        ...
        <>
            ...
            >
                <motion.h2
                    ...
                    className=" text-white  font-bold mb-20 text-center flex flex-col gap-5"
                >
                    {title || (
                        <>
                            <span className="uppercase text-5xl container">Enhancing Digital Presence with<br></br> AI for a Smarter Future</span>
                            <span className=" text-sm mx-auto leading-normal my-3 container">
                                Our team leverages artificial intelligence to boost your digital presence. We design advanced AI and ML tools and robust software solutions to streamline your operations and enhance online visibility. Looking to innovate or optimize your digital strategy? We provide the expertise and technology to realize your vision. Partner with us for a smarter, more connected future.</span>
                        </>
                    )}
                </motion.h2>
